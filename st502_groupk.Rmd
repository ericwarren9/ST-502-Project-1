...
for (i in 1:6) {
  ...
  plot(df$p, df$prop, col = i, type = "l", lwd = 2,
       ...
       ylab = "of Confidence Intervals Containing p",
       xlab = "p",
       main = paste("Proportion of Confidence Intervals Containing p with n =", n_, names(results)[i]))
...
for (i in 1:6) {
  ...
  plot(df$p, df$prop, col = i, type = "l", lwd = 2,
       ylim = c(0,1), xlim = c(0,1),
       #add appropriate labels
       ylab = "Proportion of Confidence Intervals Containing p",
       xlab = "p",
       main = paste("Proportion of Confidence Intervals Containing p with n =", n_, names(results)[i]))
  #add line for nominal confidence level
  abline(h = 0.95,lwd = 1.5)
...
for (n_ in n) {
  ...
  plot(NA, ylim = c(0,0.7), xlim = c(0,1), 
       #add appropriate labels
  ...
  legend(0.77, 
         0.73, 
         legend = c("Wald","AdjWald","Exact","Score","Raw","Boott"), 
         lty = 1, 
         lwd = 2, 
         col = 1:6, 
         cex = 0.7
